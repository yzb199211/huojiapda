package com.yyy.huojiapda.login;
...
import com.yyy.huojiapda.BaseActivity;
import com.yyy.huojiapda.BuildConfig;
import com.yyy.huojiapda.main.MainActivity;
import com.yyy.huojiapda.R;
import com.yyy.huojiapda.interfaces.PermissionListener;
import com.yyy.huojiapda.login.model.LoginBean;
import com.yyy.pda.BaseApplication;
import com.yyy.pda.dialog.JudgeDialog;
...
import com.yyy.pda.util.FileUtil;
...
import com.yyy.pda.util.VersionUtil;
...
//                    finish();
     ...
     * @param intent
     */
    private void permission(final Intent intent) {
...
//                downFile("http://wap.apk.anzhi.com/data5/apk/201812/12/com.evernote_04286100.apk");
    ...
    private void downFile(String url) {
        ...
        file = FileUtil.creatFile(dirfile, "zhongdahuajia.apk");


        new NetUtil(url, Environment.getExternalStorageDirectory().getAbsolutePath(), "/zhongda/zhongdahuajia.apk", new NetUtil.OnDownloadListener() {
            @Override
